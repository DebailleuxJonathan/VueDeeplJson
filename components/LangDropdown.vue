...
<template>
  <Listbox as="div" v-model="props.lang">
    <div class="flex justify-between">
      ...
      <ListboxLabel v-if="!props.isLoaded" class="block text-sm font-medium leading-6 text-green-900">En attente...</ListboxLabel>
    </div>
    <div class="relative mt-2">
      <ListboxButton
          class="relative w-full cursor-pointer rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
